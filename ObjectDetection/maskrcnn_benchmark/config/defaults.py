...
# Weight Norm options
# ---------------------------------------------------------------------------- #
_C.MODEL.WEIGHTNORM = CN()
# WN's small constant in the denominator
_C.MODEL.WEIGHTNORM.EPSILON = 1e-5
# WN's Scale
_C.MODEL.WEIGHTNORM.SCALE = 1.414
# Whether WN's Scale can be learned?
_C.MODEL.WEIGHTNORM.ADJUSTSCALE = False
# Number of dimensions per group OWN/ONI (-1 if using NUM_GROUPS)
_C.MODEL.WEIGHTNORM.DIM_PER_GP = -1
# Number of groups in Group based OWN/ONI (-1 if using DIM_PER_GP)
_C.MODEL.WEIGHTNORM.NUM_GROUPS = 1
# Iteration Number of Newton's methods for ONI
_C.MODEL.WEIGHTNORM.T = 5
...
# GN
_C.MODEL.ROI_BOX_HEAD.USE_GN = 'No'
# Dilation
...
# GN
_C.MODEL.ROI_MASK_HEAD.USE_GN = 'No'
...
_C.SOLVER.WNSCALE_LR_FACTOR = 1 # default use the same lr as th base_lr

_C.SOLVER.MOMENTUM = 0.9

_C.SOLVER.WEIGHT_DECAY = 0.0005
_C.SOLVER.WEIGHT_DECAY_BIAS = 0
_C.SOLVER.WEIGHT_DECAY_WNSCALE = 1 # default use weight decay for WNScale
...
# Misc options
# ---------------------------------------------------------------------------- #
_C.OUTPUT_DIR = "./set_result/debug/"
